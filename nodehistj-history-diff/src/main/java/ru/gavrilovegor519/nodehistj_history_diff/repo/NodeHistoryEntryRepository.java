...
public interface NodeHistoryEntryRepository extends JpaRepository<NodeHistoryEntry, Long> {
     ...
     */
    @Query("""
        SELECT new ru.gavrilovegor519.nodehistj_history_diff.dto.NodeChangeSummaryDto(
        ...
        """)
    List<ru.gavrilovegor519.nodehistj_history_diff.dto.NodeChangeSummaryDto> getChangeSummary(
